...
const EmailValidation: React.FC = () => {
  ...
  // Lista completa de 248 correos de docentes invitados
  const emailList = [
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-blue-600">@unal.edu.co</p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Verificación de correos @unal.edu.co</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
            ...
            Lista Completa de Correos Registrados
          </h3>
          <motion.button
