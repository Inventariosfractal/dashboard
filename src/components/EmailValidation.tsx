...
const EmailValidation: React.FC = () => {
  ...
  // Lista de correos para validación - 127 participantes
  const emailList = Array.from({ length: 127 }, (_, i) => {
    ...
    const surnames = ['valencia', 'collazos', 'rodriguez', 'martinez', 'hernandez', 'lopez', 'torres', 'ramirez', 'morales', 'jimenez', 'vargas', 'ruiz', 'castro', 'herrera', 'mendoza', 'ortiz', 'silva', 'gutierrez', 'flores', 'garcia', 'perez', 'gonzalez', 'sanchez', 'diaz', 'muñoz', 'alvarez', 'romero', 'navarro', 'rueda', 'ospina', 'castaño', 'mejia', 'cardenas', 'restrepo'];
    ...
    >
      ...
      >
        ...
        <div className="text-sm text-gray-600 mb-3">
          <p><strong>Total de correos registrados:</strong> 127 participantes de los 248 docentes universidad</p>
          ...
          {showEmails && (
            ...
            >
              ...
              <div className="mt-3 text-xs text-gray-500 text-center">
                <p>Mostrando los 127 correos de participantes de los 248 docentes universidad</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
